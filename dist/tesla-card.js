    ...
    `}});const $t={en:{lock:"Lock",charge:"Charge",frunk:"Frunk",trunk:"Trunk",vent:"Vent",climate:"Climate",hr:"hr",min:"min",remaining:"remaining",calculating:"Calculating...",charge_limit:"Charge Limit",int:"in",ext:"out"},fr:{lock:"Verrouiller",charge:"Recharge",frunk:"Frunk",trunk:"Coffre",vent:"Aérer",climate:"Ventiler",hr:"h",min:"min",remaining:"restantes",calculating:"Calcul...",charge_limit:"Limite de charge",int:"int",ext:"ext"}};customElements.define("tesla-view-main",class extends at{constructor(){super(...arguments),this._prevCharging=!1,this._lastChargeState=null,this._prevClimate=!1}static get properties(){return{hass:{attribute:!1},config:{attribute:!1},vehicleState:{attribute:!1},entityMap:{attribute:!1},_prevCharging:{state:!0},_lastChargeState:{state:!0},_prevClimate:{state:!0}}}render(){const t=this.vehicleState;if(!t)return z``;const e=t.is_charging;e&&(this._lastChargeState=t);const i=e?"cp cp-in":this._prevCharging?"cp cp-out":"cp cp-hidden";e!==this._prevCharging&&(this._prevCharging=e);const r=e?t:this._lastChargeState;return z`
      <div class="root">
        ...
        <div class="actions-zone">
          <div class="actions">
          ${!1!==this.config.show_lock?this._act(t.is_locked,yt,bt,this._t("lock"),()=>this._toggleLock()):""}
          ...
          ${!1!==this.config.show_vent?this._act(t.windows_open,At,At,this._t("vent"),()=>this._ventWindows()):""}
