    ...
    `}});const $e={en:{lock:"Lock",charge:"Charge",frunk:"Frunk",trunk:"Trunk",vent:"Vent",climate:"Climate",hr:"hr",min:"min",remaining:"remaining",calculating:"Calculating...",charge_limit:"Charge Limit",int:"in",ext:"out"},fr:{lock:"Verrouiller",charge:"Recharge",frunk:"Frunk",trunk:"Coffre",vent:"Aérer",climate:"Ventiler",hr:"h",min:"min",remaining:"restantes",calculating:"Calcul...",charge_limit:"Limite de charge",int:"int",ext:"ext"}};customElements.define("tesla-view-main",class extends ae{constructor(){super(...arguments),this._prevCharging=!1,this._lastChargeState=null,this._prevClimate=!1}static get properties(){return{hass:{attribute:!1},config:{attribute:!1},vehicleState:{attribute:!1},entityMap:{attribute:!1},_prevCharging:{state:!0},_lastChargeState:{state:!0},_prevClimate:{state:!0}}}render(){const e=this.vehicleState;if(!e)return z``;const t=e.is_charging;t&&(this._lastChargeState=e);const i=t?"cp cp-in":this._prevCharging?"cp cp-out":"cp cp-hidden";t!==this._prevCharging&&(this._prevCharging=t);const r=t?e:this._lastChargeState;return z`
      <div class="root">
        ...
        <div class="actions-zone">
          <div class="actions">
          ${!1!==this.config.show_lock?this._act(e.is_locked?"grey":"white",e.is_locked?ye:be,this._t("lock"),()=>this._toggleLock()):""}
          ${!1!==this.config.show_charge_port?this._act(e.is_charging?"green":e.charger_door_open?"white":"grey",we,this._t("charge"),()=>this._toggleChargePort()):""}
          ${!1!==this.config.show_frunk?this._act(e.frunk_open?"white":"grey",Pe,this._t("frunk"),()=>this._openFrunk()):""}
          ${!1!==this.config.show_trunk?this._act(e.trunk_open?"white":"grey",xe,this._t("trunk"),()=>this._toggleTrunk()):""}
          ${!1!==this.config.show_vent?this._act(e.windows_open?"white":"grey",Ae,this._t("vent"),()=>this._ventWindows()):""}
          ${!1!==this.config.show_climate?this._act(e.is_climate_on?"white":"grey",Ce,this._t("climate"),()=>this._toggleClimate()):""}
          </div>
        </div>
      </div>
